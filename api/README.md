...
Copy `.env.example` to `.env` and fill in real values — see `CakePHPDivergance.md`
(this directory) for why this app has no `config/app_local.php`. Environment-agnostic
settings live in `config/app.php`.
