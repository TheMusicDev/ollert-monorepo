...
/**
 * Stub for the `/api/orgs*` routes (see config/routes.php). Owned by
 * `feat/api-organizations` (Section 2, be-tasks.md), which adds the
 * `index`/`add`/`view`/`edit`/`delete` actions here — see
 * planning/api-contract.md#organizations for the contract they implement.
 *
