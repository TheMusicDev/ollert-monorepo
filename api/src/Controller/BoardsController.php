...
/**
 * Stub for the `/api/orgs/:id/boards*` and `/api/boards/:id*` routes (see
 * config/routes.php). Owned by `feat/api-boards` (Section 2, be-tasks.md),
 * which adds the `index`/`add`/`view`/`edit`/`delete` actions here — see
 * planning/api-contract.md#boards for the contract they implement.
 *
