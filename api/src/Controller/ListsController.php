...
/**
 * Stub for the `/api/boards/:id/lists*` and `/api/lists/:id*` routes (see
 * config/routes.php). Owned by `feat/api-lists` (Section 2, be-tasks.md),
 * which adds the `add`/`edit`/`delete` actions here — see
 * planning/api-contract.md#lists for the contract they implement.
 *
