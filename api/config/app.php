...
return [
    ...
    'EmailTransport' => [
        'default' => [
            ...
            'timeout' => 30,
            /*
             * It is recommended to set these options through your environment (.env)
             */
            //'username' => null,
            //'password' => null,
            'client' => null,
    ...
    'Datasources' => [
        /*
         * Per-environment values (the `url` DSN below) come from `.env` via
         * `env('DATABASE_URL')` — see CakePHPDivergance.md.
         */
        'default' => [
