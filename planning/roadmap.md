...
* **DB**: MySQL owned by CakePHP, not Supabase Postgres — keeps Supabase strictly to identity, avoids coupling app schema to a Supabase project. ~~**SUPERSEDED 2026-08-24**~~ by the all-in-Supabase decision below — kept here as the historical record; local dev runs Postgres now (spine landed 2026-08-27), prod cutover pending.
